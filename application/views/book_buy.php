			...
			<?php 
				...
				<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<div class="description">
						<h5>send your query here </h5>
						<?php 
									            $code=$this->uri->segment(3);
										          echo form_open(base_url()."index.php/Welcome/book_msg/".$row->code);
												   $attr=array("type"=>"text","name"=>"msg","class"=>"form-control","required"=>"","style"=>"width:500px");
													 echo form_input($attr);
													 echo "<br>";
													 echo form_submit(array("type"=>"submit","value"=>"send","class"=>"btn btn-success"));
													  echo form_close();
						  ?>
					...
					<div class="occasion-cart">
						<div class="chr single-item single_page_b">
							 <a href="<?php echo base_url("index.php/Welcome/add_cart/".$row->code)?>"  class="abtxt1">
