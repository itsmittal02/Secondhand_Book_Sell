						  ...
						  <div class="testi-grids">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-9 team-w3ls-txt">
										  ...
										  <p>Lorem ipsum dolor sit amet.Cras rutrum iaculis enim, non mattis.</p>
                                            <h5><?php echo "$row->book_author<br>";?><a href="<?php echo base_url("index.php/Welcome/book_profile/".$row->code)?>"><button class="btn btn-danger" style="float:left">Book Profile<br></button></a></h5>
                                        </div>
	...
	?>
	                   ...
	                   <div class="thumb_top">
					    ...
					    <div class="jobs_right">
							<h5 class="title">Haven't any Book</h5>
