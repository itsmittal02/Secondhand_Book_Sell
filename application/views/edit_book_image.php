                ...
                <div id="loginbox" style="margin-top:30px;" class="mainbox  loginbox">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <div class="panel-title">Upload Book</div>
                            
                        </div>
                        <div style="padding-top:30px" class="panel-body">
                            <div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div>
					   <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">Upload Book</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">	
										  ...
										  if(isset($rd)){
											  foreach($rd as $row){
											   ...
											   echo form_open_multipart(base_url()."index.php/Upload/do_upload/".$row->code);
											    }
										    }
											  
											?>
										  <input type="file" name="userfile" size="20" class="form-control"/><br/><br />
