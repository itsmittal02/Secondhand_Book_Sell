					  ...
					  <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
										...
										<span  class="fa fa-inbox" aria-hidden="true" style="size:48px"> Inbox</span></a>
                                    </li>
                                    <li>
                                       <a href="http://[::1]/ci1/index.php/Welcome/sent">
                                    <span  class="fa fa-send" aria-hidden="true" style="size:48px">  Sent</span>
						...
						?> 
									<div class="col-md-9 col-sm-9 col-xs-9 team-w3ls-txt">
                                           <h5><?php 
										      ...
										      echo "$row->msg<br>";?></h5>
											  <h4><?php echo "$row->reply_date<br>";?></h4><br>
											  <h6><a href="<?php echo base_url("index.php/Welcome/book_buy/".$row->to_code)?>"  class="abtxt1">
											   <button class="btn btn-success"  style="float:left">Reply</button></a> 
											 <a href="<?php echo base_url("index.php/Welcome/book_profile/".$row->to_code)?>"  class="abtext">
										    <button class="btn btn-danger" style="float:right" >View Profile</button></a> </h6>
									  </div>
