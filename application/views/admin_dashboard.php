        ...
        <div id="content" style="background-color:white;">
         ...
         <!-- Main Content -->
			...
			<div class="col-sm-3"> </div>
			 ...
			 <center> <h1 class="h3 mb-4 text-gray-800">Category</h1></center>
           ...
           <tr><td>
                ...
                <?Php
		                     ...
		                     echo form_open(base_url()."index.php/Admin/add_category/");
							 echo "<br><br>";
							             echo form_label(" Category");
									     $attr=array("type"=>"text","name"=>"book_category", "class"=>"form-control", "required"=>"");
									     echo form_input($attr);
									      echo "<br>";
									 
									echo form_submit(array("type"=>"submit","name"=>"Submit","value"=>"submit", "class"=>"btn btn-success"));
		  ...
		  <?php
		    ...
		    <table class="table table-borderless w3-card-4">
			    <tr>
			      ...
			      <td><a href="<?php echo base_url("index.php/Admin/edit_book_category/".$row->code)?>"  ><i  style="font-size:25px;color:blue;cursor:pointer;" class="fa fa-edit"></i></a></td>
                  <td><a href="<?php echo base_url("index.php/Admin/delete_book_category/".$row->code)?>"><i  style="font-size:25px;color:red;cursor:pointer;"  class="fa fa-trash"></i></a></td>
			    </tr>
			</table>
