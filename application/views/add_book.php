    ...
    <div id="home">
        ...
        <div class="login-form section text-center">
			...
			<?Php
		                  if(isset ($h)){
                              foreach($h as $row){
                          echo form_open(base_url()."index.php/Welcome/book_signup");
						  ?>
							 <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">Book Name</label>
									<div class="col-md-9 col-sm-9 col-xs-9">
									<?php
									     $attr=array("type"=>"text","name"=>"book_name","placeholder"=>"Book Name", "class"=>"form-control","required"=>"");
		 ...
		 ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
									<?php
									      $attr=array("type"=>"text","name"=>"book_author","placeholder"=>"Author Name","class"=>"form-control","required"=>"");
										   echo form_input($attr);
										   echo "<br>";
									?>
					 </div>
							...
							<div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
									<?php
									      $attr=array("type"=>"text","name"=>"book_edition","placeholder"=>"Edition Name","class"=>"form-control","required"=>"");
										   echo form_input($attr);
										   echo "<br>";
									?>
	            ...
	            <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
									<?php
									      $attr=array("type"=>"text","name"=>"book_amount","placeholder"=>"Enter Amount","class"=>"form-control","required"=>"");
										   echo form_input($attr);
										   echo "<br>";
									?>
				...
				<div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
									<?php
									      $attr=array("type"=>"text","name"=>"book_description","placeholder"=>"Enter  Description","class"=>"form-control","required"=>"");
										   echo form_input($attr);
										   echo "<br>";
									?>
				...
				<div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
									<?php
									      $attr=array("type"=>"text","name"=>"book_quantity","placeholder"=>"Enter Quantity","class"=>"form-control","required"=>"");
										   echo form_input($attr);
										   echo "<br>";
									?>
							 ...
							 <div style="margin-top:10px" class="form-group">
									...
									<a>
									<?php
									echo form_submit(array("type"=>"submit","name"=>"book_signup","value"=>"Add Book","class"=>"btn btn-success"));
...
?>
                           ...
                           <?php  
						         echo form_close();
									 if(isset($book_name) && isset($book_author) && isset($book_edition) && isset($book_amount)
										&& isset($book_description) && isset($book_quantity)){
										 echo $book_name." ".$book_author." ".book_edition." ".$book_amount." ".$book_description." ".$book_quantity; 
										 }
								   }
								}
	 ?>
